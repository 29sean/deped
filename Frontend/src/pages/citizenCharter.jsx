            ...
            <div className='w-75 m-auto border rounded shadow-lg' style={{ backgroundColor: '#f5f9ff' }}>
                ...
                <div className='m-auto mt-3 mb-3' style={{ width: "85%" }}>
                    <div className='m-auto'>
                        ...
                        <div className="mb-3 rounded p-3" style={{ backgroundColor: "#dfe7f5" }} controlId="yesno">
                            <p>Are you aware of the Citizen's Charter - document of the SDO services and requirements?</p>
                            <div>
                                <Form.Check
                                    type="radio"
                                    label="Yes"
