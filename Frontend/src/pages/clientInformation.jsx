...
function clientInformation() {
    ...
    return (
        <div className='pt-5 pb-5' style={{ backgroundColor: "#edf3fc" }}>
            <div className='w-75 m-auto border rounded shadow-lg' style={{ backgroundColor: '#f5f9ff', width: '80%' }}>
                <Header />
                <div className='m-auto mt-3 mb-3' style={{ width: "85%" }}>
                    <div className='m-auto'>
                        ...
                        <div className="mb-3 rounded p-3" style={{ backgroundColor: "#dfe7f5" }} controlId="age">
                            <p>Age</p>
                            <Form.Control
                                type="number"
                        ...
                        <div className="mb-3 rounded p-3" style={{ backgroundColor: "#dfe7f5" }} controlId="sex">
                            <p>Sex</p>
                            <div>
                                <Form.Check
                                    type="radio"
                        ...
                        <div className="mb-3 rounded p-3" style={{ backgroundColor: "#dfe7f5" }} controlId="customerType">
                            <p>Customer Type</p>
                            <div>
                                <Form.Check
                                    type="radio"
